...
Si vous êtes très en avance, essayer l'algorithme [fastText](https://fasttext.cc/docs/en/supervised-tutorial.html) sur le jeu de données complet, on pourra s'appuyer sur le package fastrtext. Comparer avec les résultats obtenus par XGBoost & LIBLinear.
...
Dans notre cas (langue française) on pourrait s'appuyer sur les modèles [FlauBERT](https://huggingface.co/transformers/model_doc/flaubert.html) ou [CamemBERT](https://huggingface.co/transformers/model_doc/camembert.html) mais ce n'est pas faisable facilement en R pour l'instant, [voici une piste](https://blogs.rstudio.com/ai/posts/2019-09-30-bert-r/) qui utilise le package reticulate.
...
library(wordVectors)
library(magrittr)
#A télécharger ici http://embeddings.net/frWac_non_lem_no_postag_no_phrase_200_cbow_cut100.bin
